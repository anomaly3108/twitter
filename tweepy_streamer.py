...
# Source-Sentiment Graph
    ...
    fig = plt.gcf()
    plt.show()
    fig.savefig(r'UI\static\media\1.png', bbox_inches='tight')
...
# Sentiment Distribution Graph
    ...
    fig = plt.gcf()
    plt.show()
    fig.savefig(r'UI\static\media\2.png', bbox_inches='tight')
...
# Sentiment of tweets by hour of day
    ...
    fig = plt.gcf()
    plt.show()
    fig.savefig(r'UI\static\media\3a.png', bbox_inches='tight')
    ...
    fig = plt.gcf()
    plt.show()
    fig.savefig(r'UI\static\media\3b.png', bbox_inches='tight')
...
# Average retweets and likes by sentiment
    ...
    fig = plt.gcf()
    plt.show()
    fig.savefig(r'UI\static\media\4a.png', bbox_inches='tight')
    ...
    fig = plt.gcf()
    plt.show()
    fig.savefig(r'UI\static\media\4b.png', bbox_inches='tight')
...
# Likes and retweets by sentiment
    ...
    for i, j, k in itertools.zip_longest(lst, range(len(lst)), cs):
        ...
        fig = plt.gcf()
        plt.show()
        fig.savefig(r'UI\static\media\5_{0}.png'.format(i), bbox_inches='tight')
...
# Popular hashtags
    ...
    fig = plt.gcf()
    plt.show()
    fig.savefig(r'UI\static\media\6.png', bbox_inches='tight')
...
# Popular words in tweets
    ...
    fig = plt.gcf()
    plt.show()
    fig.savefig(r'UI\static\media\7.png', bbox_inches='tight')
